...
void pwm_init() {
  ...
  int Cycles_PWM2_SM0 = 0;
  int Cycles_PWM2_SM2 = 0;
  int Cycles_PWM2_SM3 = 0;
  int Cycles_PWM4_SM2 = 0;
  int Cycles_PWM3_SM1 = 0;
  int Cycles_PWM1_SM3 = 0;
...
void pwm_enable_output() {
  ...
  FLEXPWM2_OUTEN = 0b1101'1101'0000;
  FLEXPWM3_OUTEN = 0b0010'0010'0000;
  FLEXPWM4_OUTEN = 0b0100'0100'0000;
...
void pwm_disable_output() {
  ...
  // jeweils ENA ENB ENX    ACHTUNG SM0 bis SM3
  FLEXPWM1_OUTEN = 0b0000'0000'0000;
  FLEXPWM2_OUTEN = 0b0000'0000'0000;
  FLEXPWM3_OUTEN = 0b0000'0000'0000;
  FLEXPWM4_OUTEN = 0b0000'0000'0000;
...
static void pwm4_sm0_isr() { pwm_on_isr(); }

void pwm_enable_reload_interrupt_isr() {
  FLEXPWM4_SM0INTEN |= FLEXPWM_SMINTEN_CMPIE(1 << 4); // Enable interrupt on val 4
  // TODO check if we can to this once at init because seems kind of suss to
  // register the isr again and again.
  attachInterruptVector(IRQ_FLEXPWM4_0, pwm4_sm0_isr);
